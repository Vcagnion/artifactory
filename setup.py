...
try:
    ...
    read_md = lambda fname: open(
        os.path.join(os.path.dirname(__file__), fname), "r"
    ).read()
...
setup(
    ...
    url="https://github.com/Vcagnion/artifactory",
    download_url="https://github.com/Vcagnion/artifactory",
    install_requires=["requests", "python-dateutil"] + ["pathlib2"]
